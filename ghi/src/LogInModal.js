...
function LogInModal() {
  ...
  const {show, e_username, password } = useSelector(state => state.account);
          ...
          <form method="POST" onSubmit={preventDefault(logIn, target)}>
            <div className="field">
              ...
              <div className="control">
                <input required onChange={field} value={e_username} name="e_username" className="input" type="email" placeholder="you@example.com" />
              </div>
            </div>
            <div className="field">
